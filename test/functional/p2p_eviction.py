...
class P2PEvict(BitcoinTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        # The choice of maxconnections=46 results in a maximum of 21 tx-relaying inbound connections
        # (32 - 10 outbound - 1 feeler) * 0.6 = 21. The other inbound slots are reserved for block-relay-only
        ...
        self.extra_args = [['-maxconnections=46']]
